...
GET_POLISH_NOTATION=get_polish_notation
SOURCE_GET_POLISH_NOTATION=$(GET_POLISH_NOTATION).c
OBG_GET_POLISH_NOTATION=$(GET_POLISH_NOTATION).o

PROG=graph

CLEAN=rm -f
CLEAN_LIST=$(PROG) $(OBG_GET_TOKENS) $(TEST_GET_TOKENS) $(OBG_MAIN) $(OBG_INPUT_CHECK) $(OBG_CONFIG)\
	   $(OBG_GET_POLISH_NOTATION)
...
$(PROG):$(OBG_GET_TOKENS) $(OBG_INPUT_CHECK) $(OBG_MAIN) $(OBG_CONFIG) $(OBG_GET_POLISH_NOTATION)
	$(CC) $(FLAGS) $^ -o $@
...
$(OBG_GET_POLISH_NOTATION): $(SOURCE_GET_POLISH_NOTATION)
	$(CC) $(FLAGS) -c $^
